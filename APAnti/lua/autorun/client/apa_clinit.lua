...
hook.Add("PlayerInitialSpawn", "APAntiUpdateNotice", function()
	hook.Remove("PlayerInitialSpawn", "APAntiUpdateNotice")
	timer.Simple(1, function()
		chat.AddText(Color(255,170,0), "[APAnti] ", Color(255,255,255), "APAnti has updated make sure to update your server settings!\n")
